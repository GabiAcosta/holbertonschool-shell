0. This script prints “Hello, World”, followed by a new line to the standard output.
...
15. This scrpt displays the number of lines that contain the pattern “bin” in the file /etc/passwd.
